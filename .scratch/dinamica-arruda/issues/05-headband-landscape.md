...
Fazer a fase ativa do Turno de Palavra na Testa privilegiar a orientação paisagem em celulares e tablets, mantendo o Desafio legível, o tempo separado do conteúdo e gestos simples enquanto o aparelho está apoiado na testa.
...
4. Substituir o posicionamento `fixed` concorrente de `.game-timer` e `.challenge-card` por CSS Grid no modo paisagem; manter um fallback explícito em retrato com a instrução de giro.
