...
- A auditoria no navegador cobriu cadastro, contraste automático, persistência na edição, rejeição de texto, layout móvel em 390 × 844 e ausência de erros no console. O pacote final usa o cache `dinamica-arruda-v19`.
